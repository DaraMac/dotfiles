...
require("lazy").setup({
    ...
    { -- Highlight, edit, and navigate code
        ...
        opts = {
            ensure_installed = { 'bash', 'c', 'css', 'csv', 'diff', 'html', 'java', 'javascript', 'json', 'latex', 'ledger', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'python', 'toml', 'vim', 'xml', 'vimdoc', 'yaml', 'zathurarc' },
                ...
                textobjects = {
                    select = {
                        ...
                        keymaps = {
                            ...
                            ["ai"] = { query = "@conditional.outer", desc = "Select outer part of an [i]f" },
                            ["ii"] = { query = "@conditional.inner", desc = "Select inner part of an [i]f" },
